    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <h5 class="card-title d-flex flex-column">
                <strong>C.V: </strong>
                <div class="mx-5">
                    <a href="{{ route('user.demande.cv.pdf', basename($stg->cv, '.pdf')) }}" target="_blank" class="btn btn-success"><i
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="panelsStayOpen-headingOne{{ $key }}">
                        <button class="accordion-button text-bg-light border border-1 border-dark" type="button"
                            data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseOne{{ $key }}" aria-expanded="true"
                    ...
                    <div id="panelsStayOpen-collapseOne{{ $key }}" class="accordion-collapse collapse"
                        ...
                        <div class="accordion-body text-bg-light border border-1 border-dark">
                            ...
                            <h5 class="card-title d-flex flex-column">
                                ...
                                <div class="mx-5">
                                    <a href="{{ route('user.demande.lm.pdf', basename($demande->lettre_motivation, '.pdf')) }}" target="_blank" class="btn btn-success"><i
                                        class="fas fa-eye"></i></a>
                                </div>
                            </h5>
                                ...
                                <div class="accordion" id="accordionExampleS{{ $key }}">
                                    <div class="accordion-item">
                                        <h2 class="accordion-header" id="headingOneS{{ $key }}">
                                            <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOneS{{ $key }}"
                                                aria-expanded="true" aria-controls="collapseOneS{{ $key }}">
                                                <strong>Stage #{{ $demande->getStageByDemandeId($demande->id)->id }}</strong>
                                            </button>
                                        </h2>
                                        <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOneS{{ $key }}"
                                            ...
                                            <div class="accordion-body">
                                                <h5 class="card-title mt-3">
                                                    ...
                                                    <span
                                                        ...
                                                        {{ $demande->getStageByDemandeId($demande->id)->statut == -1? 'préstage' : (
                                                ...
                                                <h5 class="card-title d-flex flex-column">
                                                    ...
                                                    <div class="mx-5">
                                                        <a href="{{ route("user.stage.fc.pdf",
                                                            basename($demande->getStageByDemandeId($demande->id)->fiche_confirmation, '.pdf')) }}"
                                                ...
                                                <h5 class="card-title d-flex flex-column">
                                                    ...
                                                    <div class="mx-5">
                                                        <a href="{{ route("user.stage.fe.pdf",
                                                            basename($demande->getStageByDemandeId($demande->id)->fiche_evaluation, '.pdf')) }}"
                                                            target="_blank" class="btn btn-primary">
                                                            <i class="fas fa-eye"></i>
                                                        </a>
                                                    </div>
                                                ...
                                                <h5 class="card-title d-flex flex-column">
                                                    ...
                                                    <div class="mx-5">
                                                        <a href="{{ route("user.stage.rap.pdf",
                                                            basename($demande->getStageByDemandeId($demande->id)->rapport, '.pdf')) }}"
                                                            target="_blank" class="btn btn-primary">
                                                            <i class="fas fa-eye"></i>
                                                        </a>
                                                    </div>
                                                ...
                                                <h5 class="card-title d-flex flex-column">
                                                    ...
                                                    <div class="mx-5">
                                                        <a href="{{ route('user.stage.att', $demande->getStageByDemandeId($demande->id)->id) }}"
                                                            target="_blank"
