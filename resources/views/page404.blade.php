...
<div class="message-box" style="font-family: Arial, Helvetica, sans-serif">
    <h1>404</h1>
    <p class="fs-3">Page non trouvée</p>
    <div class="buttons-con">
        <div class="action-link-wrap">
            <a href="{{ url()->previous() }}" class="btn btn-light my-3">RETOUR A LA PAGE PRECEDENTE</a>
            <a href="{{ Route('accueil') }}" class="btn btn-light">RETOUR A L'ACCUEIL</a>
        </div>
    </div>
</div>
@endsection
