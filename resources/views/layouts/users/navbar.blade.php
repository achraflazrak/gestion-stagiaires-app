<nav class="navbar navbar-expand-md navbar-dark bg-dark shadow-sm p-4">
    <div class="container">
        ...
        <a class="text-light text-decoration-none ms-3" href="{{ route('users.offers.show') }}">Offres</a>
        <a class="text-light text-decoration-none ms-3" href="{{ route('user.demande.create') }}">Créer une demande</a>
